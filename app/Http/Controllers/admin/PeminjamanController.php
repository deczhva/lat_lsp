...
class PeminjamanController extends Controller
{
    ...
    {
        $peminjaman = Peminjaman::where('user_id', Auth::admin()->id)->get();
    ...
    {
        $buku = Buku::all();
        return view('admin.peminjaman.form', compact('buku')); 
    }
    ...
    public function form(Request $request)
    {
        ...
        return view('admin.peminjaman.form', compact('buku', 'buku_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($peminjaman){
            return redirect()->route('admin.peminjaman.riwayat')->with('status', 'success')->with('msg', 'berhasil menambah data');
        }
